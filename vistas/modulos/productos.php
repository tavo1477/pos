        ...
        <div class="modal-body">
          ...
          <!-- ENTRADA PARA SELECCIONAR CATEGORÍA -->     
             ...
             <!--  ENTRADA PARA EL CÓDIGO -->
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control input-lg" id="nuevoCodigo" name="nuevoCodigo" placeholder="Ingresar código" readonly>

                </div>          

              </div>  

              <!--  ENTRADA PARA LA DESCRICIÓN -->
            ...
            <div class="form-group">
              ...
              <img src="vistas/images/productos/default/anonymous.png" class="img-thumbnail previsualizar" width="100px">
